...
object PlantIdMock : PlantIdentifierAPI{
    ...
    private fun probabilityFrom(suggestion: JSONObject) = suggestion.getDouble("probability")

    private fun imageURLFrom(suggestion: JSONObject) =
        suggestion.getJSONObject("plant_details").getJSONObject("wiki_image").getString("value")

    private fun plantNameFrom(json: JSONObject): String{
        return json.getString("plant_name")
    }
